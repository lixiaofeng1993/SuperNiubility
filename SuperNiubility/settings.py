...
BROKER_URL = 'redis://:123456@127.0.0.1:6379/0' if platform.system() == "Windows" else "amqp://guest@localhost//"

# BACKEND配置，这里使用redis
CELERY_RESULT_BACKEND = 'redis://:123456@127.0.0.1:6379/0' if platform.system() == "Windows" else "amqp://guest@localhost//"
