...
from public.conf import Email, EmailPassword
...
def send_email(to_email: str, code: str):
    ...
    msg['from'] = Header("Super Niubility", "utf-8")
    msg['to'] = to_email
    ...
    html = f"""
        ...
        <body>
            ...
            <p style="color: red;font-size: 18px;">{code}<span style="color: #979797;font-size: 12px;">（未保证您账号的安全性，请在1小时内完成验证.）</span></p>
        </body>
        </html>
    """
